...
export default function SharePresetDialog({ children, className, activePreset }: SharePresetDialogProps) {
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      const result: ShareApiResponse = await saveSharedPreset(pinCode, activePreset);
